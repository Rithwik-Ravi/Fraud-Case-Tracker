    ...
    <div className="interrupt-screen min-h-screen">
      ...
      <div className="border-b border-danger-200 bg-danger-600 text-white">
        <div className="mx-auto max-w-3xl px-4 py-10 sm:py-14">
          <p className="mb-3 inline-flex items-center gap-2 rounded-full bg-white/20 px-3 py-1 text-xs font-bold uppercase tracking-wider text-white">
            <ShieldAlert className="h-4 w-4" aria-hidden="true" />
            Official I4C Cyber Crime Coordination Advisory, MHA
          </p>
            ...
            <div className="w-full">
              ...
              <div className="mt-6 grid gap-4 sm:grid-cols-2">
                <div className="rounded-ux-xl border border-danger-200 bg-white p-4">
                  ...
                  <a
                    href="tel:1930"
                    className="mt-3 inline-flex items-center gap-1.5 rounded-ux bg-danger-600 px-4 py-2 text-sm font-bold text-white hover:bg-danger-700 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-danger-600 focus-visible:ring-offset-2"
                  >
                    <span>Dial 1930</span>
                  </a>
                </div>

                <div className="rounded-ux border border-brand-200 bg-white p-4">
                  ...
                  <a
                    ...
                    className="mt-3 inline-flex items-center gap-1.5 rounded-ux border-2 border-brand-500 bg-white px-4 py-2 text-sm font-bold text-brand-700 hover:bg-brand-50 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-brand-600 focus-visible:ring-offset-2"
                  >
              ...
              <div className="mt-8 border-t border-ink-200 pt-6">
                <p className="text-sm text-ink-500">
                  CasePilot is an independent civic prototype, not affiliated with the Government of India.
                </p>
